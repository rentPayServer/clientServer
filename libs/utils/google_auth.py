...
def create_google_token_url(gtoken,name):
    return pyotp.totp.TOTP(gtoken).provisioning_uri("alice@google.com",  issuer_name="新星鹭({})".format(name))


if __name__ == '__main__':
    res = pyotp.totp.TOTP('4S4G7CBWJHYAD5ZE').provisioning_uri("alice@google.com",  issuer_name="新星鹭")
